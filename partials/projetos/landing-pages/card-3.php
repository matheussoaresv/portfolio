<div class="card"
    ...
    data-title="WSI - Agência de SEO"
    data-imgs='[
       "assets/img/wsi-agencia/banner.webp",
       "assets/img/wsi-agencia/cases.webp",
       "assets/img/wsi-agencia/diferenciais.webp",
       "assets/img/wsi-agencia/depoimentos.webp"
     ]'>

    <div class="card__img">
        <img width="500" height="400" class="object-fit-cover w-100 h-100"
            src="assets/img/wsi-agencia/img-top.webp"
            alt="Chemitec - GoFind">
    </div>
    <div class="card__subtitle">Landing Page</div>
    <div class="card__subtitle"><strong>Segmento:</strong> Marketing Digital</div>
