<section id="especialidade" class="py-5">
  ...
  19.8922 11.8742V14.7235C19.8922 15.2278 19.7589 15.7254 19.5119 16.1662C18.7615 15.3596 17.6806 14.8528
   ...
   20.3676C11.9347 20.5316 11.1396 20.4203 10.4684 20.0413H10.4676Z">
                        ...
                        <br>
                        <h3 class="fs-5 fw-bold">UI / EX Designer</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col slide-up">
                <div class="e-card playing">
                    ...
                    <div class="infotop">
                        ...
                        <br>
                        <h3 class="fs-5 fw-bold">Desenvolvedor <br>Front End</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col slide-right">
                <div class="e-card playing">
                    ...
                    <div class="infotop">
                        ...
                        <br>
                        <h3 class="fs-5 fw-bold">Especialista em Performance Web</h3>
                    </div>
                </div>
            </div>
        </div>
