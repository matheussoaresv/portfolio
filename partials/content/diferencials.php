<section id="especialidade" class="py-4">
    <div class="container-lg">
        <p class="text-center">Como desenvolvedor front-end com experiência em criar interfaces modernas e funcionais, ajudo você a construir a presença digital e a landing page ideal para a sua marca.</p>
